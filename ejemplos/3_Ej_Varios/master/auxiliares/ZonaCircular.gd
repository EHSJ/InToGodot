...
var radio = 0
export (Color) var cBorde = Color(255,255,255,255)
export (Color) var cRelleno = Color(0,0,0,0)

func _ready():
	radio = get_parent().get_radius()

func _draw():
	draw_circle_arc(get_pos(),radio,0,360,cBorde,1)
